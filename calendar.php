...
<br />
<b>Available in 38 languages and dialects:</b> Arabian, Argentinian Spanish, Armenian, Bahasa (Indonesia), Brasilian Portuguese, Bulgarian, Catalan, Chinese (Simplified), Czech, Danish, Deutch, Dutch, English (US & GB), Finnish, French, Greek, Hebrew, Hindi, Italian, Japanese, Korean, Norwegian (Bokmål & Nynorsk), Polish, Portuguese, Romanian, Russian, Serbian (Latin), Slovak, Spanish, Swedish, Thai, Turkish, Ucrainean, Ungarian, Vietnamese, Yoruba (and counting...)
...
<!-- END OF: Needed for the manual Language selector - not needed if you pass the LANG from your own script -->
	  ...
	  $myCalendar->dateAllow('2012-01-27', '2020-03-01', false);
	  //$myCalendar->autoSubmit(true, "", "test.php");
	  //$myCalendar->autoSubmit(true, "form1");
	  $myCalendar->showWeeks(false);

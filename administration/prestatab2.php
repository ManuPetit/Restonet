...
<div id="tabs-2">
	<table width="100%" border="0" cellpadding="5px">
		<tr valign="top">
			...
			<td></td>
			<td><?php create_form_input('desc', 'textarea2', $errors, 40, 10000);?></td>
		</tr>
		<tr valign="top">
			...
			?><small>(optionnel)</small><br /><small>Type de fichiers accept&eacute;s : GIF ou JPG, dont la taille est inf&eacute;rieure &agrave; 5Mo.</small></td>
		</tr>
		<tr valign="top">
		...
		<tr valign="top">
			...
			<select name="commission">
				...
				if (isset($_POST['commission'])) {
					...
					echo '<option value="' . $comm[0]['commissionID'] . '" selected="selected">' . $comm[0]['commissionNom'] . '</option>';
		...
		<tr valign="top">
			...
			<select name="valeur">
				...
				if (isset($_POST['valeur'])) {
					...
					echo '<option value="' . $valeur[0]['valeurID'] . '" selected="selected">' . $valeur[0]['valeurNom'] . '</option>';
					for ($i = 1; $i < count($valeur); $i++) {
						echo '<option value="' . $valeur[$i]['valeurID'] . '">' . $valeur[$i]['valeurNom'] . '</option>';
					}
				}
				?>
		...
		<tr valign="top">
			...
			<select name="delai">
				...
				if (isset($_POST['delai'])) {
					...
					echo '<option value="' . $delai[0]['id'] . '" selected="selected">' . $delai[0]['temps'] . '</option>';
					for ($i = 1; $i < count($delai); $i++) {
						echo '<option value="' . $delai[$i]['id'] . '">' . $delai[$i]['temps'] . '</option>';
					}
				}
				?>
